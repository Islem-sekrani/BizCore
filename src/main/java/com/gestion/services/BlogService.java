...
public class BlogService implements IBlogService {
    ...
    public boolean addArticle(Blog article) {
        String query = "INSERT INTO article (titre, contenu, image_principale, categorie, statut, nombre_vues) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    @Override
    public boolean updateArticle(Blog article) {
        String query = "UPDATE article SET titre = ?, contenu = ?, image_principale = ?, categorie = ?, statut = ?, nombre_vues = ? WHERE id_article = ?";
    ...
    @Override
    public Blog getArticleById(int idArticle) {
