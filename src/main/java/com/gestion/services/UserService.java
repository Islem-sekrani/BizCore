...
public class UserService implements IUserService {
    ...
    public boolean addUser(User user) {
        String query = "INSERT INTO users (nom, prenom, email, password, id_role, statut, email_confirmed, confirmation_token) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            pstmt.setBoolean(7, false); // email not confirmed yet
            pstmt.setString(8, user.getConfirmationToken());
    ...
    public boolean confirmUser(String token) {
        ...
        String sql = "UPDATE users SET email_confirmed = true, confirmation_token = NULL WHERE confirmation_token = ?";
    ...
    public boolean createResetToken(String email, String token, Timestamp expiry) {
